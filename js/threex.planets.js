...
THREEx.Planets.createSun	= function(){
	...
	var texture	= THREE.ImageUtils.loadTexture('img/sun.jpg')
...
THREEx.Planets.createMoon	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		...
		bumpMap	: THREE.ImageUtils.loadTexture('img/moonbump1k.jpg'),
		bumpScale: 0.002,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createJupiter	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.ImageUtils.loadTexture('img/jupitermap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.02,
...
THREEx.Planets.createSaturnRing	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src	= 'img/saturnringpattern.gif';
	}, false);
	imageMap.src	= 'img/saturnringcolor.jpg';
	
	var geometry	= new THREEx.Planets._RingGeometry(0.55, 0.75, 64);
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
		// map		: THREE.ImageUtils.loadTexture('img/ash_uvgrid01.jpg'),
		side		: THREE.DoubleSide,
		transparent	: true,
		opacity		: 0.8,
	})
...
THREEx.Planets.createUranus	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.ImageUtils.loadTexture('img/uranusmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createUranusRing	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src	= 'img/uranusringtrans.gif';
	}, false);
	imageMap.src	= 'img/uranusringcolour.jpg';
...
THREEx.Planets.createNeptune	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.ImageUtils.loadTexture('img/neptunemap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
